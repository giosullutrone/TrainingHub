...
class ModelTemplateRecipe:
    ...
    MODEL_SYSTEM_TEMPLATE: Union[str, None] = None
...
class LLama2ModelTemplateRecipe(ModelTemplateRecipe):
    MODEL_RESPONSE_TEMPLATE = " [/INST]"
    MODEL_SYSTEM_TEMPLATE = " <<SYS>>\n "
    @staticmethod
